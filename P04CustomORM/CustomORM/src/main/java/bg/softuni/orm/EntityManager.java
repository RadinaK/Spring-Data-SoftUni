...
import static bg.softuni.entities.constants.Constants.*;
import static bg.softuni.entities.constants.Constants.Queries.*;
import static bg.softuni.entities.constants.Constants.SQLTypes.*;
import static bg.softuni.orm.Connector.getConnection;
